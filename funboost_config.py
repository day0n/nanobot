...
class BrokerConnConfig(DataClassBase):
    REDIS_HOST = os.getenv("CREATO_REDIS__HOST", "localhost")
    REDIS_USERNAME = ""
    REDIS_PASSWORD = os.getenv("CREATO_REDIS__PASSWORD", "")
    REDIS_PORT = int(os.getenv("CREATO_REDIS__PORT", "6379"))
    REDIS_DB = int(os.getenv("CREATO_REDIS__DB", "0"))
    REDIS_DB_FILTER_AND_RPC_RESULT = int(os.getenv("CREATO_REDIS__DB", "0"))
    REDIS_SSL = os.getenv("CREATO_REDIS__SSL", "false").lower() == "true"
