...
Uses a lightweight LLM (gpt-4o-mini by default) to produce a short summary
of conversation turns that were trimmed by the sliding window. The summary
is injected back into the context so the agent retains awareness of earlier
discussion without consuming the full token budget.
"""
