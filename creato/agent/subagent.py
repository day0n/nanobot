...
from creato.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
class SubagentManager:
    ...
    def __init__(
        ...
        from creato.config.schema import ExecToolConfig, WebSearchConfig
...
Summarize this naturally for the user. Keep it brief (1-2 sentences). Do not mention technical details like "subagent" or task IDs."""
    ...
    def _build_subagent_prompt(self) -> str:
        ...
        from creato.agent.prompt.identity import AGENT_NAME
