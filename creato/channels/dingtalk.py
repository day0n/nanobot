...
from creato.channels.base import BaseChannel
from creato.config.schema import Base
...
class CreatoDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Creato channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Creato via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = CreatoDingTalkHandler(self)
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "Creato Reply"},
        )
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by CreatoDingTalkHandler).
    ...
    async def _download_dingtalk_file(
        ...
        from creato.config.paths import get_media_dir
