...
# ── Module-level message helpers (used by AgentExecutor without PromptBuilder) ──
...
class PromptBuilder:
    ...
    def __init__(self, workspace: Path, skills_loader: SkillsLoader | None = None, system_prompt_override: str | None = None):
    ...
    # Delegate to module-level functions for backward compatibility
    add_tool_result = staticmethod(add_tool_result)
    add_assistant_message = staticmethod(add_assistant_message)
