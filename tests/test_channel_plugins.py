...
from creato.config.schema import ChannelsConfig
...
def test_discover_plugins_loads_entry_points():
    from creato.channels.registry import discover_plugins
...
def test_builtin_channel_default_config():
    ...
    from creato.channels.telegram import TelegramChannel
